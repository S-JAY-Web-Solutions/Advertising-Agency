...
<head>
	...
	<link rel="stylesheet" type="text/css" href="content/css/verify_email.css">
				...
				<div class="form log_form">
					<div class="form login_form">
						<form action="#">
	                        ...
	                        <span class="description">Please provide the email that you used when signed up for your account
	                            if you forgot your email,please <a href="#">contact us</a></span>
							<div class="input_box">
								<input type="email" name="email" placeholder="Enter your email" required>
								<i class="il uil-envelope-alt email"></i>
							</div>
							<button class="button">Contiune</button>
						</form>
					</div>
				</div>
			</div>
